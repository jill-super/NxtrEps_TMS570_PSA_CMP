---
title: "Hysteresis Compensation — Integration manual: HystComp_Integration_Manual"
description: "Integration manual for Hysteresis Compensation (converted)."
---

# Hysteresis Compensation — Integration manual: HystComp_Integration_Manual

> Source: `HystComp/doc/HystComp_Integration_Manual.docx` (27,811 bytes, modern Word). Converted automatically with `python-docx`: headings, lists and up to 8 tables preserved. Figures and embedded objects are not preserved — see the original file for those.
