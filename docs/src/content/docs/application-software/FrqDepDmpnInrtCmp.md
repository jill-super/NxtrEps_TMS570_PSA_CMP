...
description: "Provides frequency-dependent damping plus inertia compensation."
---
...
Provides frequency-dependent damping plus inertia compensation. It belongs to the **Application Software** layer.

## Key files

- Implementation: `src/Ap_FrqDepDmpnInrtCmp.c`
- AUTOSAR description: `autosar/` (DaVinci `*.dcf`, `*.arxml` component and data-type descriptions).
- Generator templates and wiring: `generate/` (`Ap_FrqDepDmpnInrtCmp_Cfg.arxml.tt`, `Ap_FrqDepDmpnInrtCmp_Cfg.h.tt`, `Ap_FrqDepDmpnInrtCmp_Generate.bat`, `Ap_FrqDepDmpnInrtCmp_bswmd.arxml`).
...
|---|---|---|---|
| | [Frequency_Dependant_Damping_And_Inertia_Compenstation_MDD](./doc-Frequency_Dependant_Damping_And_Inertia_Compenstation_MDD/) | converted | 933,563 bytes | `FrqDepDmpnInrtCmp/doc/Frequency_Dependant_Damping_And_Inertia_Compenstation_MDD.docx` | |
